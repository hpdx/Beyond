package com.anbetter.beyond.network.download;

import com.anbetter.beyond.network.interceptor.ResponseInterceptor;
...
public class OKHttpDownloadProgress implements Callback {

    private DownloadListener mDownloadListener;
    private String mUrl;
    private String mFilePath;

    public OKHttpDownloadProgress(String url, String filePath, DownloadListener downloadFileListener) {
        this.mUrl = url;
