 ...
 */
public abstract class BaseMultiItemQuickAdapter<T extends IMultiItemType, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    protected void removeAllChild(IExpandable parent, int parentPosition) {
        if (parent.isExpanded()) {
            List<IMultiItemType> chidChilds = parent.getSubItems();
