...
import com.trident.dating.libnetwork.okhttp.filebody.FileRequestBody;
import com.trident.dating.libnetwork.okhttp.listener.UploadProgressListener;
...
public class OKHttpUpload2<T> extends OKHttpRequest<T> {

    private Map<String, String> mFiles;
    private Map<String, String> mParams;

    public OKHttpUpload2(String url, String fileKey, String filePath, Map<String, String> params) {
    ...
    public OKHttpUpload2(String url, Map<String, String> files, Map<String, String> params,
                         UploadProgressListener<T> responseListener, Class<T> classParameter) {
        super(url, params, responseListener, classParameter);
        this.mFiles = files;
        this.mParams = params;
                                    ...
                                    OKHttpHelper.get().getDelivery().post(new Runnable() {
                                        ...
                                        public void run() {
                                            if(mResponseListener != null
                                                    && mResponseListener instanceof UploadProgressListener) {
