...
import com.an.better.netease.cloud.music.gank.child.everyday.viewholder.TwoViewHolder;
    ...
    public RecyclerView.ViewHolder onCreateBLMViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case EverydayListRequest.VIEW_TYPE_IOS_BLOCK:
                return new TwoViewHolder(ItemEverydayTwoBinding.inflate(mLayoutInflater, parent, false));
            ...
            case EverydayListRequest.VIEW_TYPE_FRONT_WEB:
                return new GridViewHolder(ItemEverydayGridBinding.inflate(mLayoutInflater, parent, false));
            default:
    ...
    public void onBindBLMViewHolder(RecyclerView.ViewHolder holder, int position, int viewType) {
        switch (viewType) {
            ...
            case EverydayListRequest.VIEW_TYPE_MEIZI:
                ...
                break;
            case EverydayListRequest.VIEW_TYPE_IOS_BLOCK:
                ((TwoViewHolder)holder).bind((ArrayList<GanKInfo>)mList.getItems().get(position).second, position);
                break;
            case EverydayListRequest.VIEW_TYPE_REST_MOVIE:
